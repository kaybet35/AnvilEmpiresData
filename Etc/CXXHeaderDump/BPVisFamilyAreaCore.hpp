#ifndef UE4SS_SDK_BPVisFamilyAreaCore_HPP
#define UE4SS_SDK_BPVisFamilyAreaCore_HPP

class ABPVisFamilyAreaCore_C : public AVisFamilyMarkerArea
{
    ...
    void ExecuteUbergraph_BPVisFamilyAreaCore(int32 EntryPoint);
}; // Size: 0x4D1
