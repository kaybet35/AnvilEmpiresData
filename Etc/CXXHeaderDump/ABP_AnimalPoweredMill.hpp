...
struct FAnimBlueprintGeneratedConstantData : public FAnimBlueprintConstantData
{
    ...
    float __FloatProperty_40;                                                         // 0x000C (size: 0x4)
    bool __BoolProperty_41;                                                           // 0x0010 (size: 0x1)
    float __FloatProperty_42;                                                         // 0x0014 (size: 0x4)
    FInputScaleBiasClampConstants __StructProperty_43;                                // 0x0018 (size: 0x2C)
    float __FloatProperty_44;                                                         // 0x0044 (size: 0x4)
    EAnimSyncMethod __EnumProperty_45;                                                // 0x0048 (size: 0x1)
    TEnumAsByte<EAnimGroupRole::Type> __ByteProperty_46;                              // 0x0049 (size: 0x1)
    FName __NameProperty_47;                                                          // 0x004C (size: 0x8)
