...
class ABPVisTempleT3_C : public AVisRelicTechCenter
{
    ...
    class UNiagaraComponent* SmokeStack2;                                             // 0x0550 (size: 0x8)
    class UNiagaraComponent* SmokeStack3;                                             // 0x0558 (size: 0x8)
    class UNiagaraComponent* SmokeStack;                                              // 0x0560 (size: 0x8)
    class UNiagaraComponent* SmokeStack1;                                             // 0x0568 (size: 0x8)
    class UVisStaticMeshComponent* Populate;                                          // 0x0570 (size: 0x8)
