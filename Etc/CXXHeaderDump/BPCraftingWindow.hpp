...
{
    class UBPHeaderContainer_C* ActionsHeader;                                        // 0x02E8 (size: 0x8)
    class UBPActionStrip_C* BPActionStrip;                                            // 0x02F0 (size: 0x8)
    class UBPAnvilPanel_C* BPAnvilPanel;                                              // 0x02F8 (size: 0x8)
    ...
    class UBPMainAreaContainer_C* InventoryContainer;                                 // 0x0310 (size: 0x8)
