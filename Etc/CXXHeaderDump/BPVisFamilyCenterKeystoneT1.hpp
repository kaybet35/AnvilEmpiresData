...
class ABPVisFamilyCenterKeystoneT1_C : public AVisFamilyCenter
{
    ...
    class UVisFoundationEdgeMeshDecorComponent* VerticalEdge02;                       // 0x0540 (size: 0x8)
    class UVisFoundationEdgeMeshDecorComponent* VerticalEdge01;                       // 0x0548 (size: 0x8)
    class UVisFoundationEdgeMeshDecorComponent* VerticalEdge03;                       // 0x0550 (size: 0x8)
    class UVisFoundationEdgeMeshDecorComponent* VerticalEdge04;                       // 0x0558 (size: 0x8)
    ...
    class UGrassRemovalVolumeComponent* GrassRemovalFamilyArea;                       // 0x0578 (size: 0x8)
