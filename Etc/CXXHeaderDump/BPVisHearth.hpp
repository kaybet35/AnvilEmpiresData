...
class ABPVisHearth_C : public AVisCookingStructure
{
    ...
    class UAudioComponent* PotBubbling;                                               // 0x0570 (size: 0x8)
    class UNiagaraComponent* Refining;                                                // 0x0578 (size: 0x8)
    class UNiagaraComponent* Burning;                                                 // 0x0580 (size: 0x8)
    class UNiagaraComponent* Fuelled;                                                 // 0x0588 (size: 0x8)
    class UAudioComponent* Campfire_Cue;                                              // 0x0590 (size: 0x8)
    class UVisStaticMeshComponent* FireWood;                                          // 0x0598 (size: 0x8)
    ...
    class UScorchEffectComponent* ScorchEffect1;                                      // 0x05C0 (size: 0x8)
