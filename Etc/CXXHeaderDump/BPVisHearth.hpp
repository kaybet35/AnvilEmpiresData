...
class ABPVisHearth_C : public AVisCookingStructure
{
    ...
    class UAudioComponent* PotBubbling;                                               // 0x0568 (size: 0x8)
    ...
    class UAudioComponent* Campfire_Cue;                                              // 0x0588 (size: 0x8)
    class UVisStaticMeshComponent* FireWood;                                          // 0x0590 (size: 0x8)
    ...
    class UVisStaticMeshComponent* VisStaticMesh;                                     // 0x05E0 (size: 0x8)
