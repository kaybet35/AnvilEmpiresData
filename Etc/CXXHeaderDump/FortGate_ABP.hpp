#ifndef UE4SS_SDK_FortGate_ABP_HPP
#define UE4SS_SDK_FortGate_ABP_HPP
...
struct FAnimBlueprintGeneratedConstantData : public FAnimBlueprintConstantData
{
    ...
    FInputScaleBiasClampConstants __StructProperty_32;                                // 0x0058 (size: 0x2C)
    float __FloatProperty_33;                                                         // 0x0084 (size: 0x4)
...
class UFortGate_ABP_C : public UVisGateAnimInstance
{
    ...
    void ExecuteUbergraph_FortGate_ABP(int32 EntryPoint);
}; // Size: 0x468
