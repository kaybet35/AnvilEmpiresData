...
class ABPVisFamilyCenterT2_C : public AVisFamilyCenter
{
    ...
    class UVisTeamMeshComponent* VisTeamMesh1;                                        // 0x04F0 (size: 0x8)
    class UBPVisFamilyMeshComponent_C* BPVisFamilyMeshComponent1;                     // 0x04F8 (size: 0x8)
    class UBPVisFamilyMeshComponent_C* BPVisFamilyMeshComponent;                      // 0x0500 (size: 0x8)
