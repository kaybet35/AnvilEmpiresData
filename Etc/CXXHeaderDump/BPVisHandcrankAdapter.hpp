#ifndef UE4SS_SDK_BPVisHandcrankAdapter_HPP
#define UE4SS_SDK_BPVisHandcrankAdapter_HPP

class ABPVisHandcrankAdapter_C : public AVisStructure
{
    ...
    void ExecuteUbergraph_BPVisHandcrankAdapter(int32 EntryPoint);
}; // Size: 0x540
