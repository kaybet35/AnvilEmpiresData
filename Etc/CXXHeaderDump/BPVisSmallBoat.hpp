...
{
    class UInstancedStaticMeshComponent* ResourceFishR3;                              // 0x0580 (size: 0x8)
    class UInstancedStaticMeshComponent* ResourceFishR1;                              // 0x0588 (size: 0x8)
    class UInstancedStaticMeshComponent* ResourceFishR2;                              // 0x0590 (size: 0x8)
