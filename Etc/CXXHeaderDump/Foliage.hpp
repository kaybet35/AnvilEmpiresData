...
{
    FFoliageInstancedStaticMeshComponentOnInstanceTakePointDamage OnInstanceTakePointDamage; // 0x08C8 (size: 0x10)
    ...
    FFoliageInstancedStaticMeshComponentOnInstanceTakeRadialDamage OnInstanceTakeRadialDamage; // 0x08D8 (size: 0x10)
    ...
    bool bEnableDiscardOnLoad;                                                        // 0x08E8 (size: 0x1)
    FGuid GenerationGuid;                                                             // 0x08EC (size: 0x10)
...
class UFoliageType : public UObject
{
    ...
    int32 OverriddenLightMapRes;                                                      // 0x0190 (size: 0x4)
    ELightmapType LightmapType;                                                       // 0x0194 (size: 0x1)
    uint8 bUseAsOccluder;                                                             // 0x0198 (size: 0x1)
    uint8 bVisibleInRayTracing;                                                       // 0x019C (size: 0x1)
    uint8 bEvaluateWorldPositionOffset;                                               // 0x019C (size: 0x1)
    int32 WorldPositionOffsetDisableDistance;                                         // 0x01A0 (size: 0x4)
