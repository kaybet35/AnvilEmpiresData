...
struct FAnimNode_ModifyCurve : public FAnimNode_Base
{
    ...
    EModifyCurveApplyMode ApplyMode;                                                  // 0x00F8 (size: 0x1)
...
{
    FPoseLink SourcePose;                                                             // 0x0090 (size: 0x10)
    EAlphaBlendOption BlendOption;                                                    // 0x00A0 (size: 0x1)
    class UCurveFloat* CustomCurve;                                                   // 0x00A8 (size: 0x8)

}; // Size: 0xB0

struct FAnimNode_PoseByName : public FAnimNode_PoseHandler
{
    FName PoseName;                                                                   // 0x0090 (size: 0x8)
    float PoseWeight;                                                                 // 0x0098 (size: 0x4)
...
{
    FPoseLink SourcePose;                                                             // 0x0090 (size: 0x10)
    TArray<FBoneReference> SourceBones;                                               // 0x00A0 (size: 0x10)
    TArray<FBoneReference> OnlyDriveBones;                                            // 0x00B0 (size: 0x10)
    TArray<FPoseDriverTarget> PoseTargets;                                            // 0x00C0 (size: 0x10)
    FBoneReference EvalSpaceBone;                                                     // 0x0100 (size: 0x10)
    bool bEvalFromRefPose;                                                            // 0x0110 (size: 0x1)
    FRBFParams RBFParams;                                                             // 0x0118 (size: 0x38)
    EPoseDriverSource DriveSource;                                                    // 0x0150 (size: 0x1)
    EPoseDriverOutput DriveOutput;                                                    // 0x0151 (size: 0x1)
    uint8 bOnlyDriveSelectedBones;                                                    // 0x0152 (size: 0x1)
    int32 LODThreshold;                                                               // 0x0154 (size: 0x4)
...
struct FAnimNode_RigidBody : public FAnimNode_SkeletalControlBase
{
    ...
    FSimSpaceSettings SimSpaceSettings;                                               // 0x0270 (size: 0x68)
    float CachedBoundsScale;                                                          // 0x02D8 (size: 0x4)
    FBoneReference BaseBoneRef;                                                       // 0x02DC (size: 0x10)
    TEnumAsByte<ECollisionChannel> OverlapChannel;                                    // 0x02EC (size: 0x1)
    ESimulationSpace SimulationSpace;                                                 // 0x02ED (size: 0x1)
    bool bForceDisableCollisionBetweenConstraintBodies;                               // 0x02EE (size: 0x1)
    bool bUseExternalClothCollision;                                                  // 0x02EF (size: 0x1)
    uint8 bEnableWorldGeometry;                                                       // 0x02F1 (size: 0x1)
    uint8 bOverrideWorldGravity;                                                      // 0x02F1 (size: 0x1)
    uint8 bTransferBoneVelocities;                                                    // 0x02F1 (size: 0x1)
    uint8 bFreezeIncomingPoseOnStart;                                                 // 0x02F1 (size: 0x1)
    uint8 bClampLinearTranslationLimitToRefPose;                                      // 0x02F1 (size: 0x1)
    float WorldSpaceMinimumScale;                                                     // 0x02F4 (size: 0x4)
    float EvaluationResetTime;                                                        // 0x02F8 (size: 0x4)
    ESimulationTiming SimulationTiming;                                               // 0x02FD (size: 0x1)
...
struct FAnimNode_SpringBone : public FAnimNode_SkeletalControlBase
{
    ...
    uint8 bLimitDisplacement;                                                         // 0x0154 (size: 0x1)
    uint8 bTranslateX;                                                                // 0x0154 (size: 0x1)
    uint8 bTranslateY;                                                                // 0x0154 (size: 0x1)
    uint8 bTranslateZ;                                                                // 0x0154 (size: 0x1)
    uint8 bRotateX;                                                                   // 0x0154 (size: 0x1)
    uint8 bRotateY;                                                                   // 0x0154 (size: 0x1)
    uint8 bRotateZ;                                                                   // 0x0154 (size: 0x1)
...
struct FAnimNode_TwistCorrectiveNode : public FAnimNode_SkeletalControlBase
{
    ...
    FAnimCurveParam Curve;                                                            // 0x0154 (size: 0xC)
...
struct FAnimNode_TwoBoneIK : public FAnimNode_SkeletalControlBase
{
    ...
    FVector EffectorLocation;                                                         // 0x00E0 (size: 0x18)
    FBoneSocketTarget EffectorTarget;                                                 // 0x0100 (size: 0x90)
    FVector JointTargetLocation;                                                      // 0x0190 (size: 0x18)
    FBoneSocketTarget JointTarget;                                                    // 0x01B0 (size: 0x90)
    FAxis TwistAxis;                                                                  // 0x0240 (size: 0x20)
    TEnumAsByte<EBoneControlSpace> EffectorLocationSpace;                             // 0x0260 (size: 0x1)
    TEnumAsByte<EBoneControlSpace> JointTargetLocationSpace;                          // 0x0261 (size: 0x1)
    uint8 bAllowStretching;                                                           // 0x0262 (size: 0x1)
    uint8 bTakeRotationFromEffectorSpace;                                             // 0x0262 (size: 0x1)
    uint8 bMaintainEffectorRelRot;                                                    // 0x0262 (size: 0x1)
    uint8 bAllowTwist;                                                                // 0x0262 (size: 0x1)
...
struct FIKFootPelvisPullDownSolver
{
    ...
    float PelvisAdjustmentInterpAlpha;                                                // 0x0060 (size: 0x4)
    float PelvisAdjustmentMaxDistance;                                                // 0x0064 (size: 0x4)
    float PelvisAdjustmentErrorTolerance;                                             // 0x0068 (size: 0x4)
    int32 PelvisAdjustmentMaxIter;                                                    // 0x006C (size: 0x4)
