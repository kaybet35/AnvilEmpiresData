...
class ABPVisTownCenterT3_C : public AVisTownCenter
{
    ...
    class UScorchEffectComponent* ScorchEffect10;                                     // 0x0508 (size: 0x8)
    class UScorchEffectComponent* ScorchEffect14;                                     // 0x0510 (size: 0x8)
    class UScorchEffectComponent* ScorchEffect13;                                     // 0x0518 (size: 0x8)
    class UScorchEffectComponent* ScorchEffect12;                                     // 0x0520 (size: 0x8)
