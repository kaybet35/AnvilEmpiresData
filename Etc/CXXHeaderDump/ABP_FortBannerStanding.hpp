#ifndef UE4SS_SDK_ABP_FortBannerStanding_HPP
#define UE4SS_SDK_ABP_FortBannerStanding_HPP
...
class UABP_FortBannerStanding_C : public UVisWeatherIndicatorAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_FortBannerStanding(int32 EntryPoint);
}; // Size: 0x3B8
