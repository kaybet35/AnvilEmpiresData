...
class ABpVisTownCenterT1_C : public AVisTownCenter
{
    ...
    class UNiagaraComponent* SmallFire;                                               // 0x0498 (size: 0x8)
    class UVisStaticMeshComponent* VisStaticMesh8;                                    // 0x04A0 (size: 0x8)
    class UVisStaticMeshComponent* VisStaticMesh7;                                    // 0x04A8 (size: 0x8)
    class UVisStaticMeshComponent* VisStaticMesh6;                                    // 0x04B0 (size: 0x8)
    class UVisStaticMeshComponent* VisStaticMesh5;                                    // 0x04B8 (size: 0x8)
    class UVisStaticMeshComponent* VisStaticMesh4;                                    // 0x04C0 (size: 0x8)
    class UVisStaticMeshComponent* VisStaticMesh3;                                    // 0x04C8 (size: 0x8)
    ...
    class UScorchEffectComponent* ScorchEffect4;                                      // 0x0500 (size: 0x8)
    ...
    class UStaticMeshComponent* DebugSphere;                                          // 0x0528 (size: 0x8)
