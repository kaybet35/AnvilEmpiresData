...
class ABPVisFoodRefineryT2_C : public AVisRefinery
{
    ...
    class UVisStaticMeshComponent* MillSmallActive2;                                  // 0x0528 (size: 0x8)
    class UNiagaraComponent* Niagara1;                                                // 0x0530 (size: 0x8)
    class UVisStaticMeshComponent* VisStaticMesh2;                                    // 0x0538 (size: 0x8)
    class UVisStaticMeshComponent* MillSmall2;                                        // 0x0540 (size: 0x8)
