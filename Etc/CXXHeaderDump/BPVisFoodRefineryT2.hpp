...
class ABPVisFoodRefineryT2_C : public AVisRefinery
{
    ...
    class UVisStaticMeshComponent* MillSmallActive1;                                  // 0x0498 (size: 0x8)
    class UVisStaticMeshComponent* MillSmallActive2;                                  // 0x04A0 (size: 0x8)
    ...
    class UVisStaticMeshComponent* MillSmall1;                                        // 0x04C8 (size: 0x8)
    ...
    class UVisStaticMeshComponent* MillSmall2;                                        // 0x04E8 (size: 0x8)
    class UVisTeamMeshComponent* VisTeamMesh;                                         // 0x04F0 (size: 0x8)
    class UVisStaticMeshComponent* VisStaticMesh;                                     // 0x04F8 (size: 0x8)
    class UScorchEffectComponent* ScorchEffect9;                                      // 0x0500 (size: 0x8)
