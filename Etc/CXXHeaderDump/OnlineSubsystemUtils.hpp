...
{
    float SocketErrorDisconnectDelay;                                                 // 0x337C (size: 0x4)

}; // Size: 0x33A0

class UIpNetDriver : public UNetDriver
{
    uint8 LogPortUnreach;                                                             // 0x0790 (size: 0x1)
    uint8 AllowPlayerPortUnreach;                                                     // 0x0790 (size: 0x1)
    uint32 MaxPortCountToTry;                                                         // 0x0794 (size: 0x4)
    uint32 ServerDesiredSocketReceiveBufferBytes;                                     // 0x079C (size: 0x4)
    uint32 ServerDesiredSocketSendBufferBytes;                                        // 0x07A0 (size: 0x4)
    uint32 ClientDesiredSocketReceiveBufferBytes;                                     // 0x07A4 (size: 0x4)
    uint32 ClientDesiredSocketSendBufferBytes;                                        // 0x07A8 (size: 0x4)
    double MaxSecondsInReceive;                                                       // 0x07B0 (size: 0x8)
    int32 NbPacketsBetweenReceiveTimeTest;                                            // 0x07B8 (size: 0x4)
    float ResolutionConnectionTimeout;                                                // 0x07BC (size: 0x4)
