...
class ABPVisFamilyCenterKeystoneT2_C : public AVisFamilyCenter
{
    ...
    class UVisFamilyMeshComponent* VisFamilyMesh;                                     // 0x0540 (size: 0x8)
    class UVisFoundationEdgeMeshDecorComponent* VerticalEdge02;                       // 0x0548 (size: 0x8)
    class UVisFoundationEdgeMeshDecorComponent* VerticalEdge04;                       // 0x0550 (size: 0x8)
    class UVisFoundationEdgeMeshDecorComponent* VerticalEdge03;                       // 0x0558 (size: 0x8)
    class UVisFoundationEdgeMeshDecorComponent* VerticalEdge01;                       // 0x0560 (size: 0x8)
    class UVisStaticMeshComponent* HouseMesh;                                         // 0x0568 (size: 0x8)
