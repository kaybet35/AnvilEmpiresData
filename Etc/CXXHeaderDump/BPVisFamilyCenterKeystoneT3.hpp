...
class ABPVisFamilyCenterKeystoneT3_C : public AVisFamilyCenter
{
    ...
    class UVisFoundationEdgeMeshDecorComponent* VerticalEdge03;                       // 0x0568 (size: 0x8)
    class UVisFoundationEdgeMeshDecorComponent* VerticalEdge01;                       // 0x0570 (size: 0x8)
    class UVisFoundationEdgeMeshDecorComponent* VerticalEdge02;                       // 0x0578 (size: 0x8)
