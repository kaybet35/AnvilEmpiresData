...
class UCheckBox : public UContentWidget
{
    ...
    TEnumAsByte<EButtonClickMethod::Type> ClickMethod;                                // 0x0C51 (size: 0x1)
    TEnumAsByte<EButtonTouchMethod::Type> TouchMethod;                                // 0x0C52 (size: 0x1)
    TEnumAsByte<EButtonPressMethod::Type> PressMethod;                                // 0x0C53 (size: 0x1)
...
class UComboBoxString : public UWidget
{
    ...
    FSlateFontInfo Font;                                                              // 0x1538 (size: 0x58)
    FSlateColor ForegroundColor;                                                      // 0x1590 (size: 0x14)
    bool bIsFocusable;                                                                // 0x15A4 (size: 0x1)
    FComboBoxStringOnGenerateWidgetEvent OnGenerateWidgetEvent;                       // 0x15A8 (size: 0x10)
    class UWidget* GenerateWidgetForString(FString Item);
    FComboBoxStringOnSelectionChanged OnSelectionChanged;                             // 0x15B8 (size: 0x10)
    void OnSelectionChangedEvent(FString SelectedItem, TEnumAsByte<ESelectInfo::Type> SelectionType);
    FComboBoxStringOnOpening OnOpening;                                               // 0x15C8 (size: 0x10)
    void OnOpeningEvent();
...
class UEditableText : public UWidget
{
    ...
    TEnumAsByte<EVirtualKeyboardType::Type> KeyboardType;                             // 0x049E (size: 0x1)
    ...
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x04A2 (size: 0x1)
...
class UEditableTextBox : public UWidget
{
    ...
    FText GetText();
    FEditableTextBoxStyle WidgetStyle;                                                // 0x0180 (size: 0xE80)
    FText HintText;                                                                   // 0x1000 (size: 0x18)
    FEditableTextBoxHintTextDelegate HintTextDelegate;                                // 0x1018 (size: 0x10)
    FText GetText();
    bool IsReadOnly;                                                                  // 0x1028 (size: 0x1)
    bool IsPassword;                                                                  // 0x1029 (size: 0x1)
    float MinimumDesiredWidth;                                                        // 0x102C (size: 0x4)
    bool IsCaretMovedWhenGainFocus;                                                   // 0x1030 (size: 0x1)
    bool SelectAllTextWhenFocused;                                                    // 0x1031 (size: 0x1)
    bool RevertTextOnEscape;                                                          // 0x1032 (size: 0x1)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x1033 (size: 0x1)
    bool SelectAllTextOnCommit;                                                       // 0x1034 (size: 0x1)
    bool AllowContextMenu;                                                            // 0x1035 (size: 0x1)
    TEnumAsByte<EVirtualKeyboardType::Type> KeyboardType;                             // 0x1036 (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x1037 (size: 0x1)
    EVirtualKeyboardTrigger VirtualKeyboardTrigger;                                   // 0x1038 (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x1039 (size: 0x1)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x103A (size: 0x1)
    ETextOverflowPolicy OverflowPolicy;                                               // 0x103B (size: 0x1)
    FShapedTextOptions ShapedTextOptions;                                             // 0x103C (size: 0x3)
    FEditableTextBoxOnTextChanged OnTextChanged;                                      // 0x1040 (size: 0x10)
    void OnEditableTextBoxChangedEvent(const FText& Text);
    FEditableTextBoxOnTextCommitted OnTextCommitted;                                  // 0x1050 (size: 0x10)
...
class UInputKeySelector : public UWidget
{
    ...
    FTextBlockStyle TextStyle;                                                        // 0x0540 (size: 0x340)
    FInputChord SelectedKey;                                                          // 0x0880 (size: 0x20)
    FMargin Margin;                                                                   // 0x08A0 (size: 0x10)
    FText KeySelectionText;                                                           // 0x08B0 (size: 0x18)
    FText NoKeySpecifiedText;                                                         // 0x08C8 (size: 0x18)
    bool bAllowModifierKeys;                                                          // 0x08E0 (size: 0x1)
    bool bAllowGamepadKeys;                                                           // 0x08E1 (size: 0x1)
    TArray<FKey> EscapeKeys;                                                          // 0x08E8 (size: 0x10)
    FInputKeySelectorOnKeySelected OnKeySelected;                                     // 0x08F8 (size: 0x10)
    void OnKeySelected(FInputChord SelectedKey);
    FInputKeySelectorOnIsSelectingKeyChanged OnIsSelectingKeyChanged;                 // 0x0908 (size: 0x10)
...
class UListView : public UListViewBase
{
    ...
    TEnumAsByte<ESelectionMode::Type> SelectionMode;                                  // 0x0B91 (size: 0x1)
...
class UMultiLineEditableText : public UTextLayoutWidget
{
    ...
    FText GetText();
    FTextBlockStyle WidgetStyle;                                                      // 0x01B0 (size: 0x340)
    bool bIsReadOnly;                                                                 // 0x04F0 (size: 0x1)
    bool SelectAllTextWhenFocused;                                                    // 0x04F1 (size: 0x1)
    bool ClearTextSelectionOnFocusLoss;                                               // 0x04F2 (size: 0x1)
    bool RevertTextOnEscape;                                                          // 0x04F3 (size: 0x1)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x04F4 (size: 0x1)
    bool AllowContextMenu;                                                            // 0x04F5 (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x04F6 (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x04F7 (size: 0x1)
    FMultiLineEditableTextOnTextChanged OnTextChanged;                                // 0x04F8 (size: 0x10)
    void OnMultiLineEditableTextChangedEvent(const FText& Text);
    FMultiLineEditableTextOnTextCommitted OnTextCommitted;                            // 0x0508 (size: 0x10)
...
class UMultiLineEditableTextBox : public UTextLayoutWidget
{
    ...
    FText GetText();
    FEditableTextBoxStyle WidgetStyle;                                                // 0x01B0 (size: 0xE80)
    bool bIsReadOnly;                                                                 // 0x1030 (size: 0x1)
    bool AllowContextMenu;                                                            // 0x1031 (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x1032 (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x1033 (size: 0x1)
    FMultiLineEditableTextBoxOnTextChanged OnTextChanged;                             // 0x1038 (size: 0x10)
    void OnMultiLineEditableTextBoxChangedEvent(const FText& Text);
    FMultiLineEditableTextBoxOnTextCommitted OnTextCommitted;                         // 0x1048 (size: 0x10)
...
class UProgressBar : public UWidget
{
    ...
    TEnumAsByte<EProgressBarFillType::Type> BarFillType;                              // 0x03E4 (size: 0x1)
    TEnumAsByte<EProgressBarFillStyle::Type> BarFillStyle;                            // 0x03E5 (size: 0x1)
...
class URichTextBlock : public UTextLayoutWidget
{
    ...
    FTextBlockStyle DefaultTextStyleOverride;                                         // 0x01B0 (size: 0x340)
    float MinDesiredWidth;                                                            // 0x04F0 (size: 0x4)
    ETextTransformPolicy TextTransformPolicy;                                         // 0x04F4 (size: 0x1)
    ETextOverflowPolicy TextOverflowPolicy;                                           // 0x04F5 (size: 0x1)
    FTextBlockStyle DefaultTextStyle;                                                 // 0x0500 (size: 0x340)
    TArray<class URichTextBlockDecorator*> InstanceDecorators;                        // 0x0840 (size: 0x10)
...
{
    TEnumAsByte<EStretch::Type> Stretch;                                              // 0x0168 (size: 0x1)
    TEnumAsByte<EStretchDirection::Type> StretchDirection;                            // 0x0169 (size: 0x1)
...
class USpinBox : public UWidget
{
    ...
    FSlateFontInfo Font;                                                              // 0x0788 (size: 0x58)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x07E0 (size: 0x1)
    float MinDesiredWidth;                                                            // 0x07E4 (size: 0x4)
    TEnumAsByte<EVirtualKeyboardType::Type> KeyboardType;                             // 0x07E8 (size: 0x1)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x07E9 (size: 0x1)
    bool SelectAllTextOnCommit;                                                       // 0x07EA (size: 0x1)
    FSlateColor ForegroundColor;                                                      // 0x07EC (size: 0x14)
    FSpinBoxOnValueChanged OnValueChanged;                                            // 0x0800 (size: 0x10)
    void OnSpinBoxValueChangedEvent(float InValue);
    FSpinBoxOnValueCommitted OnValueCommitted;                                        // 0x0810 (size: 0x10)
    void OnSpinBoxValueCommittedEvent(float InValue, TEnumAsByte<ETextCommit::Type> CommitMethod);
    FSpinBoxOnBeginSliderMovement OnBeginSliderMovement;                              // 0x0820 (size: 0x10)
    void OnSpinBoxBeginSliderMovement();
    FSpinBoxOnEndSliderMovement OnEndSliderMovement;                                  // 0x0830 (size: 0x10)
    void OnSpinBoxValueChangedEvent(float InValue);
    uint8 bOverride_MinValue;                                                         // 0x0840 (size: 0x1)
    uint8 bOverride_MaxValue;                                                         // 0x0840 (size: 0x1)
    uint8 bOverride_MinSliderValue;                                                   // 0x0840 (size: 0x1)
    uint8 bOverride_MaxSliderValue;                                                   // 0x0840 (size: 0x1)
    float MinValue;                                                                   // 0x0844 (size: 0x4)
    float MaxValue;                                                                   // 0x0848 (size: 0x4)
    float MinSliderValue;                                                             // 0x084C (size: 0x4)
    float MaxSliderValue;                                                             // 0x0850 (size: 0x4)
...
class UTextBlock : public UTextLayoutWidget
{
    ...
    FSlateFontInfo Font;                                                              // 0x01C0 (size: 0x58)
...
class UTextLayoutWidget : public UWidget
{
    ...
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x0153 (size: 0x1)
...
class UWidget : public UVisual
{
    ...
    TEnumAsByte<EMouseCursor::Type> Cursor;                                           // 0x00E2 (size: 0x1)
