...
struct FDockTabStyle : public FSlateWidgetStyle
{
    ...
    FVector2D IconSize;                                                               // 0x0D00 (size: 0x10)
    float OverlapWidth;                                                               // 0x0D10 (size: 0x4)
    FSlateColor FlashColor;                                                           // 0x0D14 (size: 0x14)
    FSlateColor NormalForegroundColor;                                                // 0x0D28 (size: 0x14)
    FSlateColor HoveredForegroundColor;                                               // 0x0D3C (size: 0x14)
    FSlateColor ActiveForegroundColor;                                                // 0x0D50 (size: 0x14)
    FSlateColor ForegroundForegroundColor;                                            // 0x0D64 (size: 0x14)
    float IconBorderPadding;                                                          // 0x0D78 (size: 0x4)
...
struct FSearchBoxStyle : public FSlateWidgetStyle
{
    ...
    FSlateFontInfo ActiveFontInfo;                                                    // 0x0E90 (size: 0x58)
...
struct FToolBarStyle : public FSlateWidgetStyle
{
    ...
    FMargin SeparatorPadding;                                                         // 0x3DD0 (size: 0x10)
    FMargin ComboButtonPadding;                                                       // 0x3DE0 (size: 0x10)
    FMargin ButtonPadding;                                                            // 0x3DF0 (size: 0x10)
    FMargin CheckBoxPadding;                                                          // 0x3E00 (size: 0x10)
    FMargin BlockPadding;                                                             // 0x3E10 (size: 0x10)
    FMargin IndentedBlockPadding;                                                     // 0x3E20 (size: 0x10)
    FMargin BackgroundPadding;                                                        // 0x3E30 (size: 0x10)
    FVector2D IconSize;                                                               // 0x3E40 (size: 0x10)
    bool bShowLabels;                                                                 // 0x3E50 (size: 0x1)
