...
class UBPFamilyAreaMarkerWindow_C : public UFamilyAreaMarkerWindow
{
    ...
    class UBPHeaderContainer_C* BPHeaderContainer2;                                   // 0x0320 (size: 0x8)
    class UBPMainAreaContainer_C* BPMainAreaContainer;                                // 0x0328 (size: 0x8)
    class UBPMainAreaContainer_C* BPMainAreaContainer_378;                            // 0x0330 (size: 0x8)
