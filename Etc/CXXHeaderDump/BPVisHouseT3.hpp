...
class ABPVisHouseT3_C : public AVisStructure
{
    ...
    class UVisStaticMeshComponent* VisStaticMesh_Roof;                                // 0x0490 (size: 0x8)
    ...
    class USceneComponent* Fire;                                                      // 0x0500 (size: 0x8)
    class UNiagaraComponent* Niagara;                                                 // 0x0508 (size: 0x8)
    class UAudioComponent* Audio;                                                     // 0x0510 (size: 0x8)
    class UNiagaraComponent* Chimney Smoke;                                           // 0x0518 (size: 0x8)
