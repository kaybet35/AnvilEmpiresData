...
struct FAnimBlueprintGeneratedConstantData : public FAnimBlueprintConstantData
{
    ...
    float __FloatProperty_98;                                                         // 0x0030 (size: 0x4)
    FName __NameProperty_99;                                                          // 0x0034 (size: 0x8)
    int32 __IntProperty_100;                                                          // 0x003C (size: 0x4)
    FAnimNodeFunctionRef __StructProperty_101;                                        // 0x0040 (size: 0x20)
    bool __BoolProperty_102;                                                          // 0x0060 (size: 0x1)
    float __FloatProperty_103;                                                        // 0x0064 (size: 0x4)
    FInputScaleBiasClampConstants __StructProperty_104;                               // 0x0068 (size: 0x2C)
    float __FloatProperty_105;                                                        // 0x0094 (size: 0x4)
    bool __BoolProperty_106;                                                          // 0x0098 (size: 0x1)
    EAnimSyncMethod __EnumProperty_107;                                               // 0x0099 (size: 0x1)
    TEnumAsByte<EAnimGroupRole::Type> __ByteProperty_108;                             // 0x009A (size: 0x1)
    FName __NameProperty_109;                                                         // 0x009C (size: 0x8)
