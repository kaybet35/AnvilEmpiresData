#ifndef UE4SS_SDK_BPVisLatticeMineChunkIron_HPP
#define UE4SS_SDK_BPVisLatticeMineChunkIron_HPP

class ABPVisLatticeMineChunkIron_C : public AVisActor
{
    ...
    void ExecuteUbergraph_BPVisLatticeMineChunkIron(int32 EntryPoint);
}; // Size: 0x4C8
