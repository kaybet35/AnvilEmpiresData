...
class ABPVisFoodRefineryT3_C : public AVisRefinery
{
    ...
    class UNiagaraComponent* Niagara2;                                                // 0x04E0 (size: 0x8)
    class UVisStaticMeshComponent* VisStaticMesh2;                                    // 0x04E8 (size: 0x8)
    class UVisStaticMeshComponent* MillSmallActive2;                                  // 0x04F0 (size: 0x8)
    class UVisStaticMeshComponent* MillSmall2;                                        // 0x04F8 (size: 0x8)
    class UVisStaticMeshComponent* MillSmallActive1;                                  // 0x0500 (size: 0x8)
