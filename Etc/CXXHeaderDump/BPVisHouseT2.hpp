...
class ABPVisHouseT2_C : public AVisHouse
{
    ...
    class UScorchEffectComponent* ScorchEffect9;                                      // 0x04C0 (size: 0x8)
    ...
    class UScorchEffectComponent* ScorchEffect3;                                      // 0x0500 (size: 0x8)
    class USceneComponent* Fire;                                                      // 0x0508 (size: 0x8)
    class UNiagaraComponent* Niagara;                                                 // 0x0510 (size: 0x8)
    class UStaticMeshComponent* StaticMesh1;                                          // 0x0518 (size: 0x8)
    class UNiagaraComponent* Chimney Smoke1;                                          // 0x0520 (size: 0x8)
