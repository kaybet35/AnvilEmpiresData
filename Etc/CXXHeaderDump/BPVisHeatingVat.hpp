...
{
    class UNiagaraComponent* Burning;                                                 // 0x0560 (size: 0x8)
    class UNiagaraComponent* Fuelled;                                                 // 0x0568 (size: 0x8)
    class UNiagaraComponent* Refining;                                                // 0x0570 (size: 0x8)
    class USceneComponent* Fire;                                                      // 0x0578 (size: 0x8)
    class UVisStaticMeshComponent* PopulatedAssets;                                   // 0x0580 (size: 0x8)
