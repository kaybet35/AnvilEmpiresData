...
class ABPVisFamilyAreaMarker_C : public AVisFamilyMarkerArea
{
    ...
    class UGrassRemovalVolumeComponent* GrassRemovalFamilyArea;                       // 0x0490 (size: 0x8)
    class UDecalComponent* FamilyArea;                                                // 0x0498 (size: 0x8)
    class UVisStaticMeshComponent* FamilyAreaFlagMesh;                                // 0x04A0 (size: 0x8)
