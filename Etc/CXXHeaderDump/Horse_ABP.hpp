...
struct FAnimBlueprintGeneratedConstantData : public FAnimBlueprintConstantData
{
    ...
    EAnimSyncMethod __EnumProperty_116;                                               // 0x002C (size: 0x1)
    TEnumAsByte<EAnimGroupRole::Type> __ByteProperty_117;                             // 0x002D (size: 0x1)
    FName __NameProperty_118;                                                         // 0x0030 (size: 0x8)
    FName __NameProperty_119;                                                         // 0x0038 (size: 0x8)
    int32 __IntProperty_120;                                                          // 0x0040 (size: 0x4)
    FName __NameProperty_121;                                                         // 0x0044 (size: 0x8)
    int32 __IntProperty_122;                                                          // 0x004C (size: 0x4)
    FInputScaleBiasClampConstants __StructProperty_123;                               // 0x0050 (size: 0x2C)
    float __FloatProperty_124;                                                        // 0x007C (size: 0x4)
    FAnimNodeFunctionRef __StructProperty_125;                                        // 0x0080 (size: 0x20)
    bool __BoolProperty_126;                                                          // 0x00A0 (size: 0x1)
    float __FloatProperty_127;                                                        // 0x00A4 (size: 0x4)
    float __FloatProperty_128;                                                        // 0x00A8 (size: 0x4)
    bool __BoolProperty_129;                                                          // 0x00AC (size: 0x1)
    EAnimSyncMethod __EnumProperty_130;                                               // 0x00AD (size: 0x1)
    TEnumAsByte<EAnimGroupRole::Type> __ByteProperty_131;                             // 0x00AE (size: 0x1)
    FName __NameProperty_132;                                                         // 0x00B0 (size: 0x8)
