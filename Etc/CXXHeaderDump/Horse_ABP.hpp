...
struct FAnimBlueprintGeneratedConstantData : public FAnimBlueprintConstantData
{
    ...
    float __FloatProperty_112;                                                        // 0x0018 (size: 0x4)
    FName __NameProperty_113;                                                         // 0x001C (size: 0x8)
    int32 __IntProperty_114;                                                          // 0x0024 (size: 0x4)
    float __FloatProperty_115;                                                        // 0x0028 (size: 0x4)
    FName __NameProperty_116;                                                         // 0x002C (size: 0x8)
    int32 __IntProperty_117;                                                          // 0x0034 (size: 0x4)
    FName __NameProperty_118;                                                         // 0x0038 (size: 0x8)
    int32 __IntProperty_119;                                                          // 0x0040 (size: 0x4)
    FInputScaleBiasClampConstants __StructProperty_120;                               // 0x0044 (size: 0x2C)
    float __FloatProperty_121;                                                        // 0x0070 (size: 0x4)
    FAnimNodeFunctionRef __StructProperty_122;                                        // 0x0078 (size: 0x20)
    bool __BoolProperty_123;                                                          // 0x0098 (size: 0x1)
    float __FloatProperty_124;                                                        // 0x009C (size: 0x4)
    float __FloatProperty_125;                                                        // 0x00A0 (size: 0x4)
    bool __BoolProperty_126;                                                          // 0x00A4 (size: 0x1)
    EAnimSyncMethod __EnumProperty_127;                                               // 0x00A5 (size: 0x1)
    TEnumAsByte<EAnimGroupRole::Type> __ByteProperty_128;                             // 0x00A6 (size: 0x1)
    FName __NameProperty_129;                                                         // 0x00A8 (size: 0x8)
...
class UHorse_ABP_C : public UVisHorseAnimInstance
{
    ...
    FAnimNode_TransitionResult AnimGraphNode_TransitionResult_5;                      // 0x03B8 (size: 0x28)
    FAnimNode_TransitionResult AnimGraphNode_TransitionResult_4;                      // 0x03E0 (size: 0x28)
    FAnimNode_TransitionResult AnimGraphNode_TransitionResult_3;                      // 0x0408 (size: 0x28)
    FAnimNode_TransitionResult AnimGraphNode_TransitionResult_2;                      // 0x0430 (size: 0x28)
    FAnimNode_TransitionResult AnimGraphNode_TransitionResult_1;                      // 0x0458 (size: 0x28)
    FAnimNode_TransitionResult AnimGraphNode_TransitionResult;                        // 0x0480 (size: 0x28)
    FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_3;                          // 0x04A8 (size: 0x48)
    FAnimNode_StateResult AnimGraphNode_StateResult_3;                                // 0x04F0 (size: 0x20)
    FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_2;                          // 0x0510 (size: 0x48)
    FAnimNode_StateResult AnimGraphNode_StateResult_2;                                // 0x0558 (size: 0x20)
    FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_1;                          // 0x0578 (size: 0x48)
    FAnimNode_StateResult AnimGraphNode_StateResult_1;                                // 0x05C0 (size: 0x20)
    FAnimNode_RandomPlayer AnimGraphNode_RandomPlayer;                                // 0x05E0 (size: 0x78)
    FAnimNode_StateResult AnimGraphNode_StateResult;                                  // 0x0658 (size: 0x20)
    FAnimNode_StateMachine AnimGraphNode_StateMachine;                                // 0x0678 (size: 0xC8)
    FAnimNode_LayeredBoneBlend AnimGraphNode_LayeredBoneBlend_1;                      // 0x0740 (size: 0xE0)
    FAnimNode_LayeredBoneBlend AnimGraphNode_LayeredBoneBlend;                        // 0x0820 (size: 0xE0)
    FAnimNode_BlendSpacePlayer AnimGraphNode_BlendSpacePlayer;                        // 0x0900 (size: 0x70)
    FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer;                            // 0x0970 (size: 0x48)
    FAnimNode_RotationOffsetBlendSpace AnimGraphNode_RotationOffsetBlendSpace;        // 0x09B8 (size: 0x118)
