...
{
    class UBPHeaderContainer_C* ActionsHeader;                                        // 0x0318 (size: 0x8)
    ...
    class UBPAnvilPanel_C* BPAnvilPanel;                                              // 0x0338 (size: 0x8)
    class UBPFooterContainer_C* BPFooterContainer;                                    // 0x0340 (size: 0x8)
    class UBPHeaderContainer_C* BPHeaderContainer;                                    // 0x0348 (size: 0x8)
    class UBPSubHeaderContainer_C* BPSubHeaderContainer;                              // 0x0350 (size: 0x8)
    class UBPMainAreaContainer_C* CookingPanel;                                       // 0x0358 (size: 0x8)
    class UBPMainAreaContainer_C* FuelPanel;                                          // 0x0360 (size: 0x8)
