...
class UBPHUDWidget_C : public UHUDWidget
{
    ...
    class UWidgetAnimation* TownStatusAlertAnimation;                                 // 0x05B8 (size: 0x8)
    class UWidgetAnimation* WinConditionAnimation;                                    // 0x05C0 (size: 0x8)
    class UBPFoodCooldownWidget_C* BPFoodCooldownWidget;                              // 0x05C8 (size: 0x8)
    class UImage* PreAlphaBadge;                                                      // 0x05D0 (size: 0x8)
