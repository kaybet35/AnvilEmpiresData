...
class UBPHUDWidget_C : public UHUDWidget
{
    ...
    class UBPHUDHintWidget_C* BPHUDHintWidget;                                        // 0x0660 (size: 0x8)
    class UBPRestedStatusWidget_C* BPRestedStatusWidget;                              // 0x0668 (size: 0x8)
    class UBPTemperatureStatusWidget_C* BPTemperatureStatusWidget;                    // 0x0670 (size: 0x8)
    class UImage* GuardThresholdIndicator;                                            // 0x0678 (size: 0x8)
    class UImage* Image;                                                              // 0x0680 (size: 0x8)
    class UImage* PreAlphaBadge;                                                      // 0x0688 (size: 0x8)
