...
class UBPHUDWidget_C : public UHUDWidget
{
    ...
    class UWidgetAnimation* TownStatusAlertAnimation;                                 // 0x05D8 (size: 0x8)
    class UWidgetAnimation* WinConditionAnimation;                                    // 0x05E0 (size: 0x8)
    class UBPFoodCooldownWidget_C* BPFoodCooldownWidget;                              // 0x05E8 (size: 0x8)
    class UImage* PreAlphaBadge;                                                      // 0x05F0 (size: 0x8)
