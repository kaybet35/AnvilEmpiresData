...
class UBPMapWidget_C : public UMapWidget
{
    ...
    class UImage* Background;                                                         // 0x0488 (size: 0x8)
    class UImage* Frame;                                                              // 0x0490 (size: 0x8)
    class UTextBlock* ObjectiveHeaderText;                                            // 0x0498 (size: 0x8)
    class UTextBlock* ObjectiveText;                                                  // 0x04A0 (size: 0x8)
    class UTextBlock* TimeOfDayText;                                                  // 0x04A8 (size: 0x8)
