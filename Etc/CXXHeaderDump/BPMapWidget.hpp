...
class UBPMapWidget_C : public UMapWidget
{
    ...
    class UImage* Background;                                                         // 0x0470 (size: 0x8)
    class UImage* Frame;                                                              // 0x0478 (size: 0x8)
    class UTextBlock* ObjectiveHeaderText;                                            // 0x0480 (size: 0x8)
    class UTextBlock* ObjectiveText;                                                  // 0x0488 (size: 0x8)
    class UTextBlock* TimeOfDayText;                                                  // 0x0490 (size: 0x8)
