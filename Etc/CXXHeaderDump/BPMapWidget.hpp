...
class UBPMapWidget_C : public UMapWidget
{
    ...
    class UTextBlock* ObjectiveText;                                                  // 0x0498 (size: 0x8)
    class UTextBlock* TimeOfDayText;                                                  // 0x04A0 (size: 0x8)
    class UMaterialInstanceDynamic* DynamicMaterialInstance;                          // 0x04A8 (size: 0x8)
