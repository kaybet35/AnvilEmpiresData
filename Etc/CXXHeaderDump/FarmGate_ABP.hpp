#ifndef UE4SS_SDK_FarmGate_ABP_HPP
#define UE4SS_SDK_FarmGate_ABP_HPP

struct FAnimBlueprintGeneratedConstantData : public FAnimBlueprintConstantData
{
    class UBlendProfile* __BlendProfile_24;                                           // 0x0008 (size: 0x8)
    class UCurveFloat* __CurveFloat_25;                                               // 0x0010 (size: 0x8)
    EAlphaBlendOption __EnumProperty_26;                                              // 0x0018 (size: 0x1)
    EBlendListTransitionType __EnumProperty_27;                                       // 0x0019 (size: 0x1)
    TArray<float> __ArrayProperty_28;                                                 // 0x0020 (size: 0x10)
    FName __NameProperty_29;                                                          // 0x0030 (size: 0x8)
    FAnimNodeFunctionRef __StructProperty_30;                                         // 0x0038 (size: 0x20)
    bool __BoolProperty_31;                                                           // 0x0058 (size: 0x1)
...
class UFarmGate_ABP_C : public UVisGateAnimInstance
{
    ...
    FAnimNode_BlendListByBool AnimGraphNode_BlendListByBool;                          // 0x0370 (size: 0x48)
    FAnimNode_Root AnimGraphNode_Root;                                                // 0x03B8 (size: 0x20)
    ...
    void ExecuteUbergraph_FarmGate_ABP(int32 EntryPoint);
}; // Size: 0x468
