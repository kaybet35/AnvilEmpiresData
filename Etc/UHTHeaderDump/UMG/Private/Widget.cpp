...
void UWidget::K2_RemoveFieldValueChangedDelegate(FFieldNotificationId FieldId, FFieldValueChangedDynamicDelegate Delegate) {
}

void UWidget::K2_BroadcastFieldValueChanged(FFieldNotificationId FieldId) {
}

void UWidget::K2_AddFieldValueChangedDelegate(FFieldNotificationId FieldId, FFieldValueChangedDynamicDelegate Delegate) {
}
