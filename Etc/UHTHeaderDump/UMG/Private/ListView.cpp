...
void UListView::OnListItemOuterEndPlayed(AActor* ItemOuter, TEnumAsByte<EEndPlayReason::Type> EndPlayReason) {
}

void UListView::OnListItemEndPlayed(AActor* Item, TEnumAsByte<EEndPlayReason::Type> EndPlayReason) {
}
