...
public:
    ...
    static void SetInputMode_UIOnlyEx(APlayerController* PlayerController, UWidget* InWidgetToFocus, EMouseLockMode InMouseLockMode, const bool bFlushInput);
    
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static void SetInputMode_GameOnly(APlayerController* PlayerController, const bool bFlushInput);
    
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static void SetInputMode_GameAndUIEx(APlayerController* PlayerController, UWidget* InWidgetToFocus, EMouseLockMode InMouseLockMode, bool bHideCursorDuringCapture, const bool bFlushInput);
