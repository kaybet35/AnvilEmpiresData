...
bool USplineComponent::DivideSplineIntoPolylineRecursiveWithDistances(float StartDistanceAlongSpline, float EndDistanceAlongSpline, TEnumAsByte<ESplineCoordinateSpace::Type> CoordinateSpace, const float MaxSquareDistanceFromSpline, TArray<FVector>& OutPoints, TArray<double>& OutDistancesAlongSpline) const {
    return false;
}

bool USplineComponent::DivideSplineIntoPolylineRecursive(float StartDistanceAlongSpline, float EndDistanceAlongSpline, TEnumAsByte<ESplineCoordinateSpace::Type> CoordinateSpace, const float MaxSquareDistanceFromSpline, TArray<FVector>& OutPoints) const {
    return false;
}

bool USplineComponent::ConvertSplineToPolyLine(TEnumAsByte<ESplineCoordinateSpace::Type> CoordinateSpace, const float MaxSquareDistanceFromSpline, TArray<FVector>& OutPoints) const {
    return false;
}

bool USplineComponent::ConvertSplineSegmentToPolyLine(int32 SplinePointStartIndex, TEnumAsByte<ESplineCoordinateSpace::Type> CoordinateSpace, const float MaxSquareDistanceFromSpline, TArray<FVector>& OutPoints) const {
    return false;
}
