...
UEngine::UEngine() {
    ...
    this->DefaultFilmGrainTexture = NULL;
    ...
    this->GPUSkinCacheVisualizationLowMemoryThresholdInMB = 2.00f;
    this->GPUSkinCacheVisualizationHighMemoryThresholdInMB = 10.00f;
    ...
    this->UseStaticMeshMinLODPerQualityLevels = false;
    this->UseSkeletalMeshMinLODPerQualityLevels = false;
