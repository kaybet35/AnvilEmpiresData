...
void UBlueprintPlatformLibrary::SetAllowedDeviceOrientation(TEnumAsByte<EScreenOrientation::Type> NewAllowedDeviceOrientation) {
}
...
TEnumAsByte<EScreenOrientation::Type> UBlueprintPlatformLibrary::GetAllowedDeviceOrientation() {
    return EScreenOrientation::Unknown;
}
