...
FTimerHandle UKismetSystemLibrary::K2_SetTimerForNextTick(UObject* Object, const FString& FunctionName) {
    return FTimerHandle{};
}
...
UClass* UKismetSystemLibrary::Conv_ObjectToClass(UObject* Object, UClass* Class) {
    return NULL;
}
