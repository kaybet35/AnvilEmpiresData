...
ULightComponentBase::ULightComponentBase(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->CastRaytracedShadow = ECastRayTracedShadow::UseProjectSetting;
...
void ULightComponentBase::SetCastRaytracedShadows(TEnumAsByte<ECastRayTracedShadow::Type> bNewValue) {
}
