...
AActor::AActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->bCallPreReplication = true;
    this->bCallPreReplicationForReplay = true;
    this->bHidden = false;
    this->bTearOff = false;
    ...
    this->bReplicateUsingRegisteredSubObjectList = false;
    this->bActorEnableCollision = true;
    this->bActorIsBeingDestroyed = false;
    this->bAsyncPhysicsTickEnabled = false;
...
void AActor::GetAttachedActors(TArray<AActor*>& OutActors, bool bResetArray, bool bRecursivelyIncludeAttachedActors) const {
}
