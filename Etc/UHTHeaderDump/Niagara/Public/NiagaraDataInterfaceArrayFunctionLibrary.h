...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static void SetNiagaraArrayUInt8Value(UNiagaraComponent* NiagaraSystem, FName OverrideName, int32 Index, int32 Value, bool bSizeToFit);
    ...
    UFUNCTION(BlueprintCallable)
    static void SetNiagaraArrayPositionValue(UNiagaraComponent* NiagaraSystem, FName OverrideName, int32 Index, const FVector& Value, bool bSizeToFit);
    ...
    UFUNCTION(BlueprintCallable)
    static int32 GetNiagaraArrayUInt8Value(UNiagaraComponent* NiagaraSystem, FName OverrideName, int32 Index);
    ...
    UFUNCTION(BlueprintCallable)
    static FVector GetNiagaraArrayPositionValue(UNiagaraComponent* NiagaraSystem, FName OverrideName, int32 Index);
