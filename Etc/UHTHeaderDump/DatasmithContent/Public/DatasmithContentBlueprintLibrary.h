...
public:
    ...
    static TArray<FString> GetDatasmithUserDataValuesForKey(UObject* Object, FName Key, bool bPartialMatchKey);
    
    UFUNCTION(BlueprintCallable)
    static FString GetDatasmithUserDataValueForKey(UObject* Object, FName Key, bool bPartialMatchKey);
