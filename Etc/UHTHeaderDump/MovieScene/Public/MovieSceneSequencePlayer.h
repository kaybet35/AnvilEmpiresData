...
class MOVIESCENE_API UMovieSceneSequencePlayer : public UObject, public IMovieSceneSequenceTickManagerClient {
    GENERATED_BODY()
public:
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FString GetSequenceName(bool bAddClientInfo) const;
