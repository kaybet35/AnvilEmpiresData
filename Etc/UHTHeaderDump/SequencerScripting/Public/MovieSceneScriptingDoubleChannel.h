...
#include "MovieSceneScriptingDoubleChannel.generated.h"
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    UMovieSceneScriptingDoubleKey* AddKey(const FFrameNumber& InTime, double NewValue, float SubFrame, ESequenceTimeUnit TimeUnit, EMovieSceneKeyInterpolation InInterpolation);
