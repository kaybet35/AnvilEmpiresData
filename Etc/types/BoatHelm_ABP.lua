...
---@field __BlendProfile_180 UBlendProfile
---@field __CurveFloat_181 UCurveFloat
---@field __EnumProperty_182 EAlphaBlendOption
---@field __EnumProperty_183 EBlendListTransitionType
---@field __ArrayProperty_184 TArray<float>
---@field __NameProperty_185 FName
---@field __IntProperty_186 int32
---@field __NameProperty_187 FName
---@field __IntProperty_188 int32
---@field __NameProperty_189 FName
---@field __IntProperty_190 int32
---@field __StructProperty_191 FInputScaleBiasClampConstants
---@field __FloatProperty_192 float
---@field __NameProperty_193 FName
---@field __IntProperty_194 int32
---@field __FloatProperty_195 float
---@field __ByteProperty_196 ESequenceEvalReinit::Type
---@field __BoolProperty_197 boolean
---@field __FloatProperty_198 float
---@field __AnimSequenceBase_199 UAnimSequenceBase
---@field __BoolProperty_200 boolean
---@field __EnumProperty_201 EAnimSyncMethod
---@field __ByteProperty_202 EAnimGroupRole::Type
---@field __NameProperty_203 FName
---@field __NameProperty_204 FName
---@field __IntProperty_205 int32
...
---@class UBoatHelm_ABP_C : UVisBoatHelmAnimInstance
...
function UBoatHelm_ABP_C:ExecuteUbergraph_BoatHelm_ABP(EntryPoint) end
