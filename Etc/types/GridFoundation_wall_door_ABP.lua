...
---@class UGridFoundation_wall_door_ABP_C : UVisGateAnimInstance
...
function UGridFoundation_wall_door_ABP_C:ExecuteUbergraph_GridFoundation_wall_door_ABP(EntryPoint) end
