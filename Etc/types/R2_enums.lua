...
EAnvilCollisionChannel = {
    ...
    AnvilCollisionChannelHouseArea = 28,
...
EAnvilStatusMessageType = {
    ...
    ItemTransfer_NotEnoughTownCurrency = 26,
    ItemTransfer_NotPublic = 27,
    ItemTransfer_InvalidTownCurrency = 28,
    Vehicle_MountBlocked = 29,
    Vehicle_ExitBlocked = 30,
    BuildSiteObstructed = 31,
    ...
    RepairOnFire = 36,
    Repairing = 37,
    TooEncumberedForActivity = 38,
    TooEncumberedToArm = 39,
    TooEncumberedItemDisarmed = 40,
    NotEnoughStamina = 41,
    WrongStance = 42,
    MissingResource = 43,
    MissingHorse = 44,
    VehicleMustBeEmpty = 45,
    VehicleInventoryMustBeEmpty = 46,
    QueueIsFull = 47,
    NotEnoughPayment = 48,
    TownNotInRareResourceArea = 49,
    TownTooClose = 50,
    ...
    AccessDeniedMustBeInHouse = 70,
    AccessDeniedTooFarToInteract = 71,
    DismantleNoPermission = 72,
    GateIsBreached = 73,
    EnemiesNearby = 74,
    UnstuckStarting = 75,
    UnstuckTimeRemaining = 76,
    UnstuckCancelledMovement = 77,
    UnstuckCancelledEnemyNearby = 78,
    UnstuckCancelledTooSoon = 79,
    UnstuckCancelledVehiclePassenger = 80,
    UnstuckAttemptFailed = 81,
    LadderTooManyPlayers = 82,
    LadderNoSpaceToRetract = 83,
    DrowningNotification = 84,
    BedClaimed = 85,
    BedAlreadyClaimed = 86,
    BedMustHaveHouseOrTentAtTown = 87,
    BedClaimCleared = 88,
    BedNotUnderCeiling = 89,
    HorseNotHungry = 90,
    PvpIsNerfed = 91,
    NoItemsForPacking = 92,
    TooManyOrFewItemsForPacking = 93,
    NoContainerForPacking = 94,
    NotAllowedInBorderZone = 95,
    SlotOccupied = 96,
    CannotTravelWithPassengers = 97,
    NumTypes = 98,
