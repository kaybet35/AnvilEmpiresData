...
EAnvilInputEventType = {
    ...
    ClaimHouse = 13,
    PledgeAsMilitia = 14,
    ReturnFromReinforcement = 15,
    CallForReinforcements = 16,
    DismantleByOfficial = 17,
    MouseRotationMovement = 18,
    MouseWheelMovement = 19,
    Mount = 20,
    WithdrawSilver = 21,
    RepairStationRepairRequest = 22,
    MouseSelect = 23,
    MouseSelectCeiling = 24,
    DisableSnapping = 25,
    SetTownName = 26,
    Reload = 27,
    Climb = 28,
    QuenchItems = 29,
    AnvilNextOutput = 30,
    AnvilPreviousOutput = 31,
    PackItems = 32,
    ToggleFamilyAreaPledgeRestriction = 33,
    IncreaseTownStatus = 34,
    RequestFamilySync = 35,
    RequestFamilyListSync = 36,
    RequestToJoinFamily = 37,
    InviteToJoinFamily = 38,
    AltAttack = 39,
    AltShield = 40,
    SwitchSeat = 41,
    StartCooking = 42,
    SubmitAvatar = 43,
    RequestUnderworldMap = 44,
    EAnvilInputEventType_MAX = 45,
}
...
EAnvilPlacementStatus = {
    ...
    RequiresAgeTime = 47,
    AqueductNotConnectedToWaterSource = 48,
