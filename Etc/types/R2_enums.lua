...
EAnvilInputEventType = {
    ...
    RequestFamilyListSync = 48,
    RequestToJoinFamily = 49,
    InviteToJoinFamily = 50,
    PledgeToTown = 51,
    AltAttack = 52,
    AltShield = 53,
    ReinforceStructure = 54,
    SwitchSeat = 55,
    EAnvilInputEventType_MAX = 56,
}
...
EAnvilPlacementStatus = {
    ...
    RequiresMoreTents = 47,
    AreaMustBeEmpty = 48,
    YouMustBeOfficial = 49,
    MustBeUniquePerTown = 50,
    RequiresTerritoryOwnership = 51,
    CantBeBuiltUnderground = 52,
    MustBeBuiltUnderground = 53,
...
EAnvilStatusMessageType = {
    ...
    FamilyLockExpiry = 110,
    TargetInUse = 111,
    ItemInUse = 112,
    MissingEquipment = 113,
    TooSoonToUse = 114,
    HitConverterOutputNotSupported = 115,
    OnlyOnePerFamily = 116,
    TargetImmuneFriendlyFire = 117,
    TargetImmuneEveryone = 118,
    ToolTierTooLow = 119,
    ToolBroke = 120,
    StructureIsBurnt = 121,
    InventoryMustBeEmpty = 122,
    PlayerDeploying = 123,
    BedNotInYourFamilyHouse = 124,
    PledgedToTown = 125,
    VehicleCannotWorldEntranceTravel = 126,
    MustBeResetBeforeFiring = 127,
    NoProjectileLoaded = 128,
    CantArmDueToHeavyTool = 129,
    ItemDisarmedDueToHeavyTool = 130,
    CantArmDueToHeavyArmour = 131,
    ItemDisarmedDueToHeavyArmour = 132,
    TemperatureTooLowToGather = 133,
    TemperatureTooLowToPlant = 134,
    TooSoonToTravel = 135,
    OutOfAmmunition = 136,
    NotValidSupportToReinforce = 137,
    OccupantMustbeMounted = 138,
    NumTypes = 139,
