...
EAnvilAccessibilityTestResult = {
    ...
    Error = 5,
    EAnvilAccessibilityTestResult_MAX = 6,
}
...
EAnvilPlacementStatus = {
    ...
    RequiresFamily = 27,
    OnlyOneFamilyCenterPerTown = 28,
    TooCloseTogether = 29,
    TooCloseToWildSpawn = 30,
    TooCloseToWater = 31,
    VehicleMustBeEmpty = 32,
    RequiresEnclosure = 33,
    RequiresValidSupport = 34,
    RequiresFoundation = 35,
    RequiresLandscape = 36,
    RequiresWater = 37,
    RequiresSnappping = 38,
    YouMustBelongToFamily = 39,
    NotAtFullHealth = 40,
    CantBuildBorderRegion = 41,
    TooCloseToBorder = 42,
    MustBePledgedToTown = 43,
    RequiresNearbyPlayers = 44,
    RequiresMorePopulation = 45,
    RequiresMoreFamilyHouses = 46,
    RequiresMoreMarketplaceAreas = 47,
    AreaMustBeEmpty = 48,
    YouMustBeOfficial = 49,
...
EAnvilStatusMessageType = {
    ...
    CampTooClose = 48,
    FamilyTooClose = 49,
    WeaponIneffective = 50,
    MarketNotOwner = 51,
    MarketInvalidItem = 52,
    TooSoonToEat = 53,
    FishingStart = 54,
    FishingHooked = 55,
    FishingCancel = 56,
    ...
    MustBeFamilyManagerToTransferItem = 72,
    ...
    BedMustHaveHouseOrTentAtTown = 90,
    BedClaimCleared = 91,
    BedNotEnclosed = 92,
    HorseNotHungry = 93,
    PvpIsNerfed = 94,
    ...
    NoContainerForPacking = 97,
    NotAllowedInBorderZone = 98,
    SlotOccupied = 99,
    CannotTravelWithPassengers = 100,
    NotEnoughSilver = 101,
    TravelDestinationUnavailable = 102,
    UnableToIncreaseStatusUsingSilver = 103,
    TaxesAreOverdue = 104,
    FamilyAllianceSet = 105,
    RequiresFamily = 106,
    RemovedFromFamily = 107,
    MustBeFamilyLeader = 108,
    TargetInUse = 109,
    ItemInUse = 110,
