...
EAnvilPlacementInfoFlag = {
    ...
    InFamilyArea = 4,
    ProximityToRoad = 5,
    RareFoodArea_Begin = 6,
    InRareFoodArea_Deer = 7,
    InRareFoodArea_Boar = 8,
    InRareFoodArea_Wheat = 9,
    InRareFoodArea_Cabbage = 10,
    InRareFoodArea_Coal = 11,
    InRareFoodArea_Clay = 12,
    InRareFoodArea_None = 13,
    RareFoodArea_End = 14,
    BeaconDetectionRangeNormal = 15,
    BeaconDetectionRangeHigh = 16,
    BeaconDetectionRangeVeryHigh = 17,
    BeaconDetectionRangeHighest = 18,
    NumTypes = 19,
    EAnvilPlacementInfoFlag_MAX = 20,
}
...
EAnvilPlayerVisEventType = {
    ...
    EAnvilPlayerVisEventType_MAX = 8,
}
...
EAnvilStatusMessageType = {
    ...
    ItemTransfer_CannotRemoveFood = 29,
    Blocked = 30,
    Vehicle_ExitBlocked = 31,
    InvalidDetachLocation = 32,
    ...
    AccessDeniedClaimedByFamily = 68,
    ...
    HorseNotHungry = 96,
    PvpIsNerfed = 97,
    NoItemsForPacking = 98,
    TooManyOrFewItemsForPacking = 99,
    NoContainerForPacking = 100,
    NotAllowedInBorderZone = 101,
    SlotOccupied = 102,
    CannotTravelWithPassengers = 103,
    NotEnoughSilver = 104,
    TravelDestinationUnavailable = 105,
    UnableToIncreaseStatusUsingSilver = 106,
    TaxesAreOverdue = 107,
    FamilyAllianceSet = 108,
    RemovedFromFamily = 109,
    MustBeFamilyLeader = 110,
    FamilyLockExpiry = 111,
    TargetInUse = 112,
    ItemInUse = 113,
    MissingEquipment = 114,
    TooSoonToUse = 115,
    HitConverterOutputNotSupported = 116,
    OnlyOnePerFamily = 117,
    TargetImmuneFriendlyFire = 118,
    TargetImmuneEveryone = 119,
    ToolTierTooLow = 120,
    ToolBroke = 121,
    ...
    PledgedToTown = 126,
    VehicleCannotWorldEntranceTravel = 127,
    MustBeResetBeforeFiring = 128,
    NoProjectileLoaded = 129,
    CantArmDueToHeavyTool = 130,
    ItemDisarmedDueToHeavyTool = 131,
    CantArmDueToHeavyArmour = 132,
    ItemDisarmedDueToHeavyArmour = 133,
    TemperatureTooLowToGather = 134,
    TemperatureTooLowToPlant = 135,
    TooSoonToTravel = 136,
    OutOfAmmunition = 137,
    NotValidSupportToReinforce = 138,
    OccupantMustbeMounted = 139,
    RopeDetachFailed_HandsFull = 140,
    NumTypes = 141,
    EAnvilStatusMessageType_MAX = 142,
}
