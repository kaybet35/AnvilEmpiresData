...
EAnvilAccessibilityTestResult = {
    ...
    Error = 7,
    EAnvilAccessibilityTestResult_MAX = 8,
}
...
EAnvilStatusMessageType = {
    ...
    MustBeFamilyManagerToTransferItem = 75,
    ...
    BedMustHaveHouseOrTentAtTown = 93,
    BedClaimCleared = 94,
    BedNotEnclosed = 95,
    HorseNotHungry = 96,
    PvpIsNerfed = 97,
    ...
    RequiresFamily = 109,
    RemovedFromFamily = 110,
    MustBeFamilyLeader = 111,
    TargetInUse = 112,
    ItemInUse = 113,
    ...
    TooCloseToExistingStructure = 118,
    TargetImmuneFriendlyFire = 119,
    TargetImmuneEveryone = 120,
    ToolTierTooLow = 121,
