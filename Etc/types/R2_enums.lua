...
EAnvilStatusMessageType = {
    ...
    InvalidDetachLocation = 29,
    BuildSiteObstructed = 30,
    ...
    MissingResource = 39,
    MissingHorse = 40,
    VehicleMustBeEmpty = 41,
    QueueIsFull = 42,
    NotEnoughPayment = 43,
    TownNotInRareResourceArea = 44,
    TownTooClose = 45,
    TownTooFar = 46,
    CampTooClose = 47,
    FamilyTooClose = 48,
    ...
    MarketPublicItemNotAllowed = 52,
    MarketNumMaxListingsReached = 53,
    TooSoonToEat = 54,
    FishingStart = 55,
    FishingHooked = 56,
    FishingCancel = 57,
    FishingSuccess = 58,
    FishingFail = 59,
    ItemNotRepairable = 60,
    ItemRepairComplete = 61,
    CannotRepairRelicItem = 62,
    RelicTechItemNotRelic = 63,
    RelicTechSubmitted = 64,
    RelicTechResearchComplete = 65,
    RelicTechResearchIncomplete = 66,
    AccessDeniedBelongsToEnemy = 67,
    AccessDeniedMustBePledged = 68,
    AccessDeniedMustBeInFamily = 69,
    AccessDeniedAlliedFamilyNotAllowed = 70,
    AccessDeniedStructureCollapsed = 71,
    AccessDeniedTooFarToInteract = 72,
    AccessDeniedFamilyDestroyed = 73,
    AccessDeniedTownDestroyed = 74,
    AccessDeniedCannotUseInVehicle = 75,
    AccessDeniedReinforcings = 76,
    MustBeFamilyMemberToAccessInventory = 77,
    DismantleNoPermission = 78,
    DismantleMustBeEmpty = 79,
    FamilyAreaMustBeEmpty = 80,
    GateIsBreached = 81,
    EnemiesNearby = 82,
    UnstuckStarting = 83,
    UnstuckTimeRemaining = 84,
    UnstuckCancelledMovement = 85,
    UnstuckCancelledEnemyNearby = 86,
    UnstuckCancelledTooSoon = 87,
    UnstuckCancelledVehiclePassenger = 88,
    UnstuckAttemptFailed = 89,
    LadderTooManyPlayers = 90,
    LadderNoSpaceToRetract = 91,
    DrowningNotification = 92,
    BedClaimed = 93,
    BedAlreadyClaimed = 94,
    BedMustHaveHouseAtTown = 95,
    BedClaimCleared = 96,
    BedNotEnclosed = 97,
    HorseNotHungry = 98,
    PvpIsNerfed = 99,
    NoItemsForPacking = 100,
    TooManyOrFewItemsForPacking = 101,
    NoContainerForPacking = 102,
    NotAllowedInBorderZone = 103,
    SlotOccupied = 104,
    CannotTravelWithPassengers = 105,
    NotEnoughSilver = 106,
    TravelDestinationUnavailable = 107,
    UnableToIncreaseStatusUsingSilver = 108,
    TaxesAreOverdue = 109,
    FamilyAllianceSet = 110,
    RequiresFamily = 111,
    RemovedFromFamily = 112,
    MustBeFamilyLeader = 113,
    TargetInUse = 114,
    ItemInUse = 115,
    MissingEquipment = 116,
    TooSoonToUse = 117,
    HitConverterOutputNotSupported = 118,
    OnlyOnePerFamily = 119,
    TooCloseToExistingStructure = 120,
    TargetImmuneFriendlyFire = 121,
    TargetImmuneEveryone = 122,
    ToolTierTooLow = 123,
    StructureIsBurnt = 124,
    InventoryMustBeEmpty = 125,
    PlayerDeploying = 126,
    BedNotInYourFamilyHouse = 127,
    PledgedToTown = 128,
    VehicleCannotWorldEntranceTravel = 129,
    MustBeResetBeforeFiring = 130,
    NoProjectileLoaded = 131,
    CantArmDueToHeavyTool = 132,
    ItemDisarmedDueToHeavyTool = 133,
    CantArmDueToHeavyArmour = 134,
    ItemDisarmedDueToHeavyArmour = 135,
    TemperatureTooLowToGather = 136,
    TemperatureTooLowToPlant = 137,
    NumTypes = 138,
