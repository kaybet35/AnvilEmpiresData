...
EAnvilStatusMessageType = {
    ...
    FishingSuccess = 59,
    FishingFail = 60,
    ItemNotRepairable = 61,
    ItemRepairComplete = 62,
    CannotRepairRelicItem = 63,
    RelicTechItemNotRelic = 64,
    RelicTechSubmitted = 65,
    RelicTechResearchComplete = 66,
    RelicTechResearchIncomplete = 67,
    AccessDeniedBelongsToEnemy = 68,
    AccessDeniedMustBePledged = 69,
    AccessDeniedMustBeInFamily = 70,
    AccessDeniedAlliedFamilyNotAllowed = 71,
    AccessDeniedStructureCollapsed = 72,
    AccessDeniedTooFarToInteract = 73,
    AccessDeniedFamilyDestroyed = 74,
    AccessDeniedTownDestroyed = 75,
    AccessDeniedCannotUseInVehicle = 76,
    ...
    PledgedToTown = 128,
    NumTypes = 129,
    EAnvilStatusMessageType_MAX = 130,
}
