...
EAnvilStatusMessageType = {
    ...
    QueueIsFull = 43,
    NotEnoughPayment = 44,
    WeaponIneffective = 45,
    MarketInvalidItem = 46,
    MarketPublicItemNotAllowed = 47,
    MarketNumMaxListingsReached = 48,
    TooSoonToEat = 49,
    FishingStart = 50,
    FishingHooked = 51,
    FishingCancel = 52,
    FishingSuccess = 53,
    FishingFail = 54,
    ItemNotRepairable = 55,
    ItemRepairComplete = 56,
    CannotRepairRelicItem = 57,
    RelicTechItemNotRelic = 58,
    RelicTechSubmitted = 59,
    RelicTechResearchComplete = 60,
    RelicTechResearchIncomplete = 61,
    AccessDeniedBelongsToEnemyTorchToAccess = 62,
    AccessDeniedBelongsToEnemy = 63,
    AccessDeniedMustBePledged = 64,
    AccessDeniedRequireHigherFamilyStatus = 65,
    AccessDeniedClaimedByFamily = 66,
    AccessDeniedAlliedFamilyNotAllowed = 67,
    AccessDeniedStructureCollapsed = 68,
    AccessDeniedStructureFamilyCollapsed = 69,
    ...
    BedClaimCleared = 93,
    HorseNotHungry = 94,
    NoItemsForPacking = 95,
    TooManyOrFewItemsForPacking = 96,
    ItemCannotBePacked = 97,
    NoContainerForPacking = 98,
    NotAllowedInBorderZone = 99,
    SlotOccupied = 100,
    NotEnoughSilver = 101,
    TravelDestinationUnavailable = 102,
    UnableToIncreaseStatusUsingSilver = 103,
    NoSilverFound = 104,
    RemovedFromFamily = 105,
    MustBeFamilyLeader = 106,
    FamilyLockExpiry = 107,
    TargetInUse = 108,
    ItemInUse = 109,
    MissingEquipment = 110,
    TooSoonToUse = 111,
    HitConverterOutputNotSupported = 112,
    OnlyOnePerFamily = 113,
    TargetImmuneFriendlyFire = 114,
    TargetImmuneEveryone = 115,
    ToolTierTooLow = 116,
    ToolBroke = 117,
    StructureIsBurnt = 118,
    InventoryMustBeEmpty = 119,
    PlayerDeploying = 120,
    BedNotInYourFamily = 121,
    PledgedToTown = 122,
    VehicleCannotWorldEntranceTravel = 123,
    MustBeResetBeforeFiring = 124,
    MustBeResetBeforeLoading = 125,
    NoProjectileLoaded = 126,
    CantArmDueToHeavyTool = 127,
    ItemDisarmedDueToHeavyTool = 128,
    CantArmDueToHeavyArmour = 129,
    TemperatureTooLowToGather = 130,
    TemperatureTooLowToPlant = 131,
    TooSoonToTravel = 132,
    OutOfAmmunition = 133,
    NotValidSupportToReinforce = 134,
    OccupantMustbeMounted = 135,
    RopeDetachFailed_HandsFull = 136,
    AvatarSubmitted = 137,
    CantDeployWhileMoving = 138,
    CannotUseWhileSwimming = 139,
    TargetTooClose = 140,
    ReducedDamageFromLowStamina = 141,
    NotEnoughPlayersToCapture = 142,
    CannotOpenBothSailAndPlank = 143,
    RelicSiteClaimed = 144,
    NumTypes = 145,
    EAnvilStatusMessageType_MAX = 146,
}
