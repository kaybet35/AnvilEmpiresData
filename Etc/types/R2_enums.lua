...
EAnvilStatusMessageType = {
    ...
    AccessDeniedFamilyDestroyed = 68,
    AccessDeniedTownDestroyed = 69,
    AccessDeniedCannotUseInVehicle = 70,
    AccessDeniedReinforcings = 71,
    DismantleNoPermission = 72,
    DismantleMustBeEmpty = 73,
    FamilyAreaMustBeEmpty = 74,
    GateIsBreached = 75,
    EnemiesNearby = 76,
    UnstuckStarting = 77,
    UnstuckTimeRemaining = 78,
    UnstuckCancelledMovement = 79,
    UnstuckCancelledEnemyNearby = 80,
    UnstuckCancelledTooSoon = 81,
    UnstuckCancelledVehiclePassenger = 82,
    UnstuckAttemptFailed = 83,
    LadderTooManyPlayers = 84,
    LadderNoSpaceToRetract = 85,
    DrowningNotification = 86,
    BedClaimed = 87,
    BedAlreadyClaimed = 88,
    BedMustHaveHouseAtTown = 89,
    BedClaimCleared = 90,
    HorseNotHungry = 91,
    NoItemsForPacking = 92,
    TooManyOrFewItemsForPacking = 93,
    ItemCannotBePacked = 94,
    NoContainerForPacking = 95,
    NotAllowedInBorderZone = 96,
    SlotOccupied = 97,
    NotEnoughSilver = 98,
    TravelDestinationUnavailable = 99,
    UnableToIncreaseStatusUsingSilver = 100,
    NoSilverFound = 101,
    RemovedFromFamily = 102,
    MustBeFamilyLeader = 103,
    FamilyLockExpiry = 104,
    TargetInUse = 105,
    ItemInUse = 106,
    MissingEquipment = 107,
    TooSoonToUse = 108,
    HitConverterOutputNotSupported = 109,
    OnlyOnePerFamily = 110,
    TargetImmuneFriendlyFire = 111,
    TargetImmuneEveryone = 112,
    ToolTierTooLow = 113,
    ToolBroke = 114,
    StructureIsBurnt = 115,
    InventoryMustBeEmpty = 116,
    PlayerDeploying = 117,
    BedNotInYourFamily = 118,
    PledgedToTown = 119,
    VehicleCannotWorldEntranceTravel = 120,
    MustBeResetBeforeFiring = 121,
    MustBeResetBeforeLoading = 122,
    NoProjectileLoaded = 123,
    CantArmDueToHeavyTool = 124,
    ItemDisarmedDueToHeavyTool = 125,
    CantArmDueToHeavyArmour = 126,
    TemperatureTooLowToGather = 127,
    TemperatureTooLowToPlant = 128,
    TooSoonToTravel = 129,
    OutOfAmmunition = 130,
    NotValidSupportToReinforce = 131,
    OccupantMustbeMounted = 132,
    RopeDetachFailed_HandsFull = 133,
    AvatarSubmitted = 134,
    CantDeployWhileMoving = 135,
    CannotUseWhileSwimming = 136,
    TargetTooClose = 137,
    NotEnoughPlayersToCapture = 138,
    NumTypes = 139,
    EAnvilStatusMessageType_MAX = 140,
}
