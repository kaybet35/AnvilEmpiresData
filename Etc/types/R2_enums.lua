...
EAnvilPlacementStatus = {
    ...
    AreaMustBeEmpty = 47,
    YouMustBeOfficial = 48,
    EAnvilPlacementStatus_MAX = 49,
}
...
EAnvilStatusMessageType = {
    ...
    BedMustHaveHouseOrTentAtTown = 86,
    BedClaimCleared = 87,
    BedNotEnclosed = 88,
    HorseNotHungry = 89,
    PvpIsNerfed = 90,
    NoItemsForPacking = 91,
    TooManyOrFewItemsForPacking = 92,
    NoContainerForPacking = 93,
    NotAllowedInBorderZone = 94,
    SlotOccupied = 95,
    CannotTravelWithPassengers = 96,
    NotEnoughSilver = 97,
    TravelDestinationUnavailable = 98,
    UnableToIncreaseStatusUsingSilver = 99,
    TaxesAreOverdue = 100,
    FamilyAllianceSet = 101,
    RequiresFamily = 102,
    RemovedFromFamily = 103,
    TargetInUse = 104,
    ItemInUse = 105,
    MissingEquipment = 106,
    TooSoonToUse = 107,
    DismantleVoteRegistered = 108,
    DismantleVoteTooSoon = 109,
    HitConverterOutputNotSupported = 110,
    OnlyOnePerFamily = 111,
    TooCloseToExistingStructure = 112,
    TargetImmuneFriendlyFire = 113,
    TargetImmuneEveryone = 114,
    ToolTierTooLow = 115,
    NumTypes = 116,
    EAnvilStatusMessageType_MAX = 117,
}
