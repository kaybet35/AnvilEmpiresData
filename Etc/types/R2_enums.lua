...
EAnvilStatusMessageType = {
    ...
    MarketPublicItemNotAllowed = 51,
    MarketNumMaxListingsReached = 52,
    TooSoonToEat = 53,
    FishingStart = 54,
    FishingHooked = 55,
    FishingCancel = 56,
    FishingSuccess = 57,
    FishingFail = 58,
    ItemNotRepairable = 59,
    ItemRepairComplete = 60,
    CannotRepairRelicItem = 61,
    RelicTechItemNotRelic = 62,
    RelicTechSubmitted = 63,
    RelicTechResearchComplete = 64,
    RelicTechResearchIncomplete = 65,
    AccessDeniedBelongsToEnemy = 66,
    AccessDeniedMustBePledged = 67,
    AccessDeniedMustBeInFamily = 68,
    AccessDeniedAlliedFamilyNotAllowed = 69,
    AccessDeniedStructureCollapsed = 70,
    ...
    MustBeFamilyMemberToAccessInventory = 76,
    DismantleNoPermission = 77,
    DismantleMustBeEmpty = 78,
    FamilyAreaMustBeEmpty = 79,
    GateIsBreached = 80,
    EnemiesNearby = 81,
    UnstuckStarting = 82,
    UnstuckTimeRemaining = 83,
    UnstuckCancelledMovement = 84,
    UnstuckCancelledEnemyNearby = 85,
    UnstuckCancelledTooSoon = 86,
    UnstuckCancelledVehiclePassenger = 87,
    UnstuckAttemptFailed = 88,
    LadderTooManyPlayers = 89,
    LadderNoSpaceToRetract = 90,
    DrowningNotification = 91,
    BedClaimed = 92,
    BedAlreadyClaimed = 93,
    BedMustHaveHouseAtTown = 94,
    BedClaimCleared = 95,
    BedNotEnclosed = 96,
    HorseNotHungry = 97,
    PvpIsNerfed = 98,
    NoItemsForPacking = 99,
    TooManyOrFewItemsForPacking = 100,
    NoContainerForPacking = 101,
    NotAllowedInBorderZone = 102,
    SlotOccupied = 103,
    CannotTravelWithPassengers = 104,
    NotEnoughSilver = 105,
    TravelDestinationUnavailable = 106,
    UnableToIncreaseStatusUsingSilver = 107,
    TaxesAreOverdue = 108,
    FamilyAllianceSet = 109,
    RequiresFamily = 110,
    RemovedFromFamily = 111,
    MustBeFamilyLeader = 112,
    TargetInUse = 113,
    ItemInUse = 114,
    MissingEquipment = 115,
    TooSoonToUse = 116,
    HitConverterOutputNotSupported = 117,
    OnlyOnePerFamily = 118,
    TooCloseToExistingStructure = 119,
    TargetImmuneFriendlyFire = 120,
    TargetImmuneEveryone = 121,
    ToolTierTooLow = 122,
    StructureIsBurnt = 123,
    InventoryMustBeEmpty = 124,
    PlayerDeploying = 125,
    BedNotInYourFamilyHouse = 126,
    PledgedToTown = 127,
    VehicleCannotWorldEntranceTravel = 128,
    MustBeResetBeforeFiring = 129,
    NoProjectileLoaded = 130,
    CantArmDueToHeavyTool = 131,
    ItemDisarmedDueToHeavyTool = 132,
    CantArmDueToHeavyArmour = 133,
    ItemDisarmedDueToHeavyArmour = 134,
    TemperatureTooLowToGather = 135,
    TemperatureTooLowToPlant = 136,
    NumTypes = 137,
    EAnvilStatusMessageType_MAX = 138,
}
