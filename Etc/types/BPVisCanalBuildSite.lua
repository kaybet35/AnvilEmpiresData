...
---@class ABPVisCanalBuildSite_C : AVisSplineBuildSite
---@field SlopeArrowDown UStaticMeshComponent
...
---@field SlopeArrowUp UStaticMeshComponent
---@field BalljointEnd USceneComponent
